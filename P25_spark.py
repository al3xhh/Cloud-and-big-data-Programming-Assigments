...
topMoviesRatingsRDD = topMoviesRatingsRDD.map(lambda movieRating: (movieRating[1][0], movieRating[1][1]))
...
moviesRatingTimestampRDD = ratingTimestampRDD.join(moviesTitlesRDD)
